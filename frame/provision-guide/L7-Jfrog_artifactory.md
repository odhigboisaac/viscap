...
1. your jfrog account details in place of `https://viscap.jfrog.io` in the defination of registry `def registry = 'https://viscap.jfrog.io'`
...
3. Maven repository name in the place of `libs-release-local` in the `"target": "viscap-libs-release-local/{1}",